...
Una vez descargamos, vamos a enviarlo a la placa que habremos conectado al USB del PC desde el editor Thonny.
...
Podemos solucionarlo desde el menú Herramientas -> Administrar pluggins (complementos)
